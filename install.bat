REM Installs Rogue's Dev IntelliJ configs into your user configs.
@echo off
echo Installing Rogue's Dev IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'RoguesDev' or 'RoguesDevAndroid'.
exit /b
